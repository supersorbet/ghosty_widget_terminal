...
const commands = [
    ...
    {
      name: "swap",
      description: "initialize atomic swap- trade ANY token anonymously",
  },
...
const commandFunctions = {
  ...
  swap: function () {
    ...
    widgetContainer.classList.add('terminal-widget');
    
    // Create a terminal-like header
    const headerBar = document.createElement('div');
    headerBar.classList.add('terminal-widget-header');
    headerBar.innerHTML = `
        ...
        <div class="terminal-title">
            <span class="text-blue">[.._42069 ~]$</span> 
            <span class="text-green">initialize --anon</span>
        </div>
    `;

    // Create a loading animation
    const loadingContainer = document.createElement('div');
    loadingContainer.classList.add('terminal-loading');
    loadingContainer.innerHTML = `
        <pre class="text-green">
Initializing Swap Protocol...
[█████░░░░░] 50% Complete
Connecting to Ghosty API...
        </pre>
    `;
    ...
    iframe.id = 'ghosty-widget';
    iframe.src = 'https://www.ghosty.cash/swap-widget/ac3788d2efef795d';
    ...
    return 'INITIALIZING SWAP PROTOCOL...';
  },
};
